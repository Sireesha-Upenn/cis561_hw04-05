Path Tracer Part I: Naive Integration of the Light Transport Equation

Rendered Image : 

![](Sireesha%20Putcha's%20renders/samples_100.png)

A na&#239;ve Monte Carlo path tracer by writing functions to
...
`Shape::Intersect` and `Shape::ComputeTBN`
----------------
...
tangent, and bitangent at the given point of intersection.
...
`NaiveIntegrator` class (30 points)
------------
